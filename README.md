...
**ONNX Runtime training** can accelerate the model training time on multi-node NVIDIA GPUs for transformer models with a one-line addition for existing PyTorch training scripts. This system is running on big-endian. [Learn more &rarr;](https://www.onnxruntime.ai/docs/#onnx-runtime-for-training)
